...
GameLogic::GameLogic(DIFICULTATS dificultat, bool music, bool sounds) : gameRunning(true), score(0), animationTime(0), animationRunning(false), dificultat(dificultat), musicsounds(music), soundsounds(sounds)
{
